...
export default function Navbar() {
  ...
  const mobileMenu = isMobileMenuOpen ? (
    <div className="fixed inset-0 top-16 z-[90] md:hidden">
      {isAuthenticated ? (
        <div className="h-full bg-slate-50 dark:bg-[#0a0a0f] flex flex-col p-4 border-t border-black/5 dark:border-white/10 overflow-y-auto">
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <button
              type="button"
              className="flex items-center gap-3 px-4 py-3 mt-4 rounded-xl text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 text-left transition-colors font-semibold"
        ...
        <div className="h-full bg-slate-50 dark:bg-[#0a0a0f] flex flex-col gap-4 p-5 border-t border-black/5 dark:border-white/10">
          <Link
            to="/login"
            onClick={closeMobileMenu}
